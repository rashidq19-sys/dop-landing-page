...
## Where things stand
- `[IMPORTANT]` main @ 3d9ec5c, clean tree, **committed but NOT pushed** (2026-08-22). The live site still shows the old "Flat monthly. No per-driver fees. Ever." claim until someone pushes. A scheduled blog agent commits straight to main and Railway auto-deploys — so the next automated deploy would ship from an origin/main that lacks this fix.
